...
export function Info(props) {
  return (
    <Icon
      ...
      {...props}
      path={[
        'M6 0C2.7 0 0 2.7 0 6s2.7 6 6 6 6-2.7 6-6-2.7-6-6-6zm0 10.5c-2.475 0-4.5-2.025-4.5-4.5S3.525 1.5 6 1.5s4.5 2.025 4.5 4.5-2.025 4.5-4.5 4.5z',
        'M6.75 5.25h-1.5V9h1.5V5.25zM6 4.5c.41421 0 .75-.33579.75-.75S6.41421 3 6 3s-.75.33579-.75.75.33579.75.75.75z'
      ]}
    />
  );
}
...
export function ArrowThinLeft(props) {
  return (
    <Icon
      ...
      {...props}
      path={[
        'M8.806 15.04a1 1 0 0 1-1.39-.023l-6.309-6.31a1 1 0 0 1 0-1.414l6.31-6.31A1 1 0 0 1 8.807.96l.036.035a1 1 0 0 1 .025 1.438L3.3 8l5.568 5.568a1 1 0 0 1-.025 1.438l-.037.035z'
      ]}
    />
  );
}
...
export function ArrowThinRight(props) {
  return (
    <Icon
      ...
      {...props}
      path={[
        'M2.583 15.017a1 1 0 0 1-1.39.024l-.036-.035a1 1 0 0 1-.025-1.438L6.7 8 1.15 2.45A1.025 1.025 0 0 1 2.6 1l6.293 6.293a1 1 0 0 1 0 1.414L5.75 11.85l-3.167 3.167z'
      ]}
    />
  );
}
...
export function Phone(props) {
  return (
    <Icon
      ...
      {...props}
      path={[
        `M15.285 12.305l-2.578-2.594a1 1 0 0 0-1.416-.002L9 12 4 7l2.294-2.294a1 1 0 0 0 .001-1.414L3.715.708a1 1 0 0 0-1.415 0L.004 3.003 0 3c0 7.18 5.82 13 13 13l2.283-2.283a1 1 0 0 0 .002-1.412z`
      ]}
    />
  );
}
