...
export function Close(props) {
  return (
    <Icon
      {...props}
      path={[
        `M255.973,358.455L102.457,511.971L0,409.518l153.515-153.516L0,102.485L102.457,0.029l153.516,153.516L409.49,0.029l102.455,102.456L358.429,256.002L512,409.518L409.49,511.971L255.973,358.455z`
      ]}
    />
  );
}
